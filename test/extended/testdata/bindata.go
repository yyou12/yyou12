...
// test/extended/testdata/isv/kafka.yaml
...
var _testExtendedTestdataIsvKafkaYaml = []byte(`apiVersion: kafka.strimzi.io/v1beta1
kind: Kafka
metadata:
  name: my-cluster
  labels: {}
...
func testExtendedTestdataIsvKafkaYamlBytes() ([]byte, error) {
	return _testExtendedTestdataIsvKafkaYaml, nil
}

func testExtendedTestdataIsvKafkaYaml() (*asset, error) {
	bytes, err := testExtendedTestdataIsvKafkaYamlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "test/extended/testdata/isv/kafka.yaml", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
var _bindata = map[string]func() (*asset, error){
	...
	"test/extended/testdata/isv/kafka.yaml":                    testExtendedTestdataIsvKafkaYaml,
	...
	"test": {nil, map[string]*bintree{
		"extended": {nil, map[string]*bintree{
			"testdata": {nil, map[string]*bintree{
				...
				"isv": {nil, map[string]*bintree{
					"kafka.yaml":          {testExtendedTestdataIsvKafkaYaml, map[string]*bintree{}},
					"operator_group.yaml": {testExtendedTestdataIsvOperator_groupYaml, map[string]*bintree{}},
					"subscription.yaml":   {testExtendedTestdataIsvSubscriptionYaml, map[string]*bintree{}},
				}},
